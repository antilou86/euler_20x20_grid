...
# define the grid = might be best as 20 arrays of 20
...
# vertical = [arr[0][0], arr[1][0], arr[2][0], arr[3][0]]
# horizontal = [arr[0][0], arr[0][1], arr[0][2], arr[0][3]]
# left_diag = [arr[0][0], arr[1][1], arr[2][2], arr[3][3]]
# right_diag = [arr[0][3], arr[1][2], arr[2][1], arr[3][0]]

def sliding_windows(array):

    #create a variable to hold the largest_product.
    largest_product = 0
